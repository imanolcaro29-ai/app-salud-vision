...
if(!pkg.dependencies?.exceljs)throw Error('Falta el generador de Excel.');
...
for(const file of ['public/shared/domain.js','public/shared/preferences.js','public/resources.js','public/boot.js','api/index.js','supabase/01_esquema.sql'])readFileSync(file);
